...
import com.snowcattle.game.service.net.tcp.process.QueueMessageExecutorProcessor;
import com.snowcattle.game.service.net.tcp.process.QueueTcpMessageExecutorProcessor;
...
/**
 * Created by jiangwenping on 17/2/7. 各种全局的业务管理器、公共服务实例的持有者，负责各种管理器的初始化和实例的获取
 */
