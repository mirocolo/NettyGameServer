...
public final class ExecutorUtil {
	...
	/**
	 * 关闭{@link ExecutorService},在关闭之前最多等待 {@link #DEFAULT_AWAIT_TERMINATE_MINUTES}分钟来满足其中已经开始任务结束
	 *
	...
	/**
	 * 关闭{@link ExecutorService},在指定的时间内{@code awaitTermateTimeout}等待 {@code
	 * executorService}中已经开始的任务尽量结束. 此实现参照{@link ExecutorService} 注释中的 {@code
	 * shutdownAndAwaitTermination}策略
	 *
